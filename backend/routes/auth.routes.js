...
import { register, login, logout, me, forgotPassword, resetPassword, verifyEmail, resendVerification, googleLogin, changePassword, updatePreferences } from "../controllers/auth.controller.js";
...
router.put("/change-password", sensitiveLimiter, protect, changePassword);
