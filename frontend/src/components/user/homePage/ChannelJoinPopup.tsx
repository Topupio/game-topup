...
const PERKS = [
    ...
    { icon: "🔑", title: "Login top-ups", note: "Members only" },
];
...
const CHANNELS = [
    {
        ...
        className: "bg-linear-to-r from-[#25d366] to-[#12b555] shadow-[0_10px_24px_-12px_rgba(37,211,102,0.8)]",
    },
    {
        ...
        className: "bg-linear-to-r from-[#29a9eb] to-[#1d8fd1] shadow-[0_10px_24px_-12px_rgba(41,169,235,0.8)]",
    },
];
            ...
            {open && (
                <>
                    ...
                    >
                        ...
                        {/* Header */}
                        <div className="relative overflow-hidden bg-linear-to-br from-slate-900 via-indigo-900 to-violet-800 px-5 pt-5 pb-10 text-white">
                            ...
                            <h2 id="channel-popup-title" className="relative mt-2.5 text-lg sm:text-2xl font-bold leading-tight tracking-tight">
                                Join Topupio &amp;{" "}
                                <span className="bg-linear-to-r from-green-400 to-cyan-300 bg-clip-text text-transparent">
                                    unlock exclusive deals
                                </span>
                            </h2>
                            <p className="relative mt-1.5 text-xs sm:text-sm text-slate-300">
                                Giveaways, flash deals and login top-up drops land with our members first.
                            </p>
                        </div>
                        ...
                        <div className="relative -mt-6 px-4 pb-4">
                            ...
                            <div className="flex flex-col gap-2.5">
                                {CHANNELS.map(({ href, Icon, title, note, className }) => (
                                    ...
                                    >
                                        <span className="pointer-events-none absolute inset-y-0 -left-[60%] w-2/5 -skew-x-20 bg-linear-to-r from-transparent via-white/35 to-transparent motion-safe:animate-[shine_3.2s_ease-in-out_infinite]" />
