        ...
        <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
            ...
            <div className="space-y-3 text-sm">
                ...
                <button
                    onClick={onProceed}
                    disabled={isDisabled}
                    className="w-full mt-4 py-3 rounded-md bg-secondary text-white font-semibold hover:bg-tertiary hover:text-gray-950 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                    {isLoading ? (
                        <>
